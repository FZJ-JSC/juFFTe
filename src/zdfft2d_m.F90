...
implicit none
complex(real64),  allocatable :: b (:), c(:)
!$OMP THREADPRIVATE(c)
complex(real32),  allocatable :: b_r32(:), c_r32(:)
!$OMP THREADPRIVATE(c_r32)
private
...
!$OMP PARALLEL PRIVATE(D)
    call zdfft2d0_32(a, a_r, b_r32, c_r32, c_r32, d, wx, wy, nx, ny, lnx, lny)
!$OMP END PARALLEL
    return
