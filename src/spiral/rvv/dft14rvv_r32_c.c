...
void dft14c_r32_(float *Y, float *X, int64_t *lp1, int64_t *mp1) {
    int64_t l1, m1;
    vfloat32m1x2_t r225, r226, r227, r228, r229, r230, r231, r232, 
            ...
            rvvx2_27, rvvx2_28;
    vfloat32m1_t  s2694, s2695, s2696, s2697, s2698, s2699, s2700, s2701, 
    ...
    for (size_t k1 = 0; k1 < m1; k1 += vl1) {
        ...
        r225 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(k1))), vl1);
        s2694 = __riscv_vget_f32m1(r225, 0);
        s2695 = __riscv_vget_f32m1(r225, 1);
        r226 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((l1)*(m1)))))), vl1);
        s2696 = __riscv_vget_f32m1(r226, 0);
        s2697 = __riscv_vget_f32m1(r226, 1);
        r227 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((2)*(l1)))*(m1)))))), vl1);
        s2698 = __riscv_vget_f32m1(r227, 0);
        s2699 = __riscv_vget_f32m1(r227, 1);
        r228 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((3)*(l1)))*(m1)))))), vl1);
        s2700 = __riscv_vget_f32m1(r228, 0);
        s2701 = __riscv_vget_f32m1(r228, 1);
        r229 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((4)*(l1)))*(m1)))))), vl1);
        s2702 = __riscv_vget_f32m1(r229, 0);
        s2703 = __riscv_vget_f32m1(r229, 1);
        r230 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((5)*(l1)))*(m1)))))), vl1);
        s2704 = __riscv_vget_f32m1(r230, 0);
        s2705 = __riscv_vget_f32m1(r230, 1);
        r231 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((6)*(l1)))*(m1)))))), vl1);
        s2706 = __riscv_vget_f32m1(r231, 0);
        s2707 = __riscv_vget_f32m1(r231, 1);
        r232 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((7)*(l1)))*(m1)))))), vl1);
        s2708 = __riscv_vget_f32m1(r232, 0);
        s2709 = __riscv_vget_f32m1(r232, 1);
        r233 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((8)*(l1)))*(m1)))))), vl1);
        s2710 = __riscv_vget_f32m1(r233, 0);
        s2711 = __riscv_vget_f32m1(r233, 1);
        r234 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((9)*(l1)))*(m1)))))), vl1);
        s2712 = __riscv_vget_f32m1(r234, 0);
        s2713 = __riscv_vget_f32m1(r234, 1);
        r235 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((10)*(l1)))*(m1)))))), vl1);
        s2714 = __riscv_vget_f32m1(r235, 0);
        s2715 = __riscv_vget_f32m1(r235, 1);
        r236 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((11)*(l1)))*(m1)))))), vl1);
        s2716 = __riscv_vget_f32m1(r236, 0);
        s2717 = __riscv_vget_f32m1(r236, 1);
        r237 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((12)*(l1)))*(m1)))))), vl1);
        s2718 = __riscv_vget_f32m1(r237, 0);
        s2719 = __riscv_vget_f32m1(r237, 1);
        r238 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((13)*(l1)))*(m1)))))), vl1);
        s2720 = __riscv_vget_f32m1(r238, 0);
        s2721 = __riscv_vget_f32m1(r238, 1);
