...
void dft10c_r32_(float *Y, float *X, int64_t *lp1, int64_t *mp1) {
    int64_t l1, m1;
    ...
    vfloat32m1_t  s442, s443, s444, s445, s446, s447, s448, s449, 
    ...
    for (size_t k1 = 0; k1 < m1; k1 += vl1) {
        ...
        r161 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(k1))), vl1);
        s442 = __riscv_vget_f32m1(r161, 0);
        s443 = __riscv_vget_f32m1(r161, 1);
        r162 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((l1)*(m1)))))), vl1);
        s444 = __riscv_vget_f32m1(r162, 0);
        s445 = __riscv_vget_f32m1(r162, 1);
        r163 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((2)*(l1)))*(m1)))))), vl1);
        s446 = __riscv_vget_f32m1(r163, 0);
        s447 = __riscv_vget_f32m1(r163, 1);
        r164 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((3)*(l1)))*(m1)))))), vl1);
        s448 = __riscv_vget_f32m1(r164, 0);
        s449 = __riscv_vget_f32m1(r164, 1);
        r165 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((4)*(l1)))*(m1)))))), vl1);
        s450 = __riscv_vget_f32m1(r165, 0);
        s451 = __riscv_vget_f32m1(r165, 1);
        r166 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((5)*(l1)))*(m1)))))), vl1);
        s452 = __riscv_vget_f32m1(r166, 0);
        s453 = __riscv_vget_f32m1(r166, 1);
        r167 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((6)*(l1)))*(m1)))))), vl1);
        s454 = __riscv_vget_f32m1(r167, 0);
        s455 = __riscv_vget_f32m1(r167, 1);
        r168 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((7)*(l1)))*(m1)))))), vl1);
        s456 = __riscv_vget_f32m1(r168, 0);
        s457 = __riscv_vget_f32m1(r168, 1);
        r169 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((8)*(l1)))*(m1)))))), vl1);
        s458 = __riscv_vget_f32m1(r169, 0);
        s459 = __riscv_vget_f32m1(r169, 1);
        r170 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((9)*(l1)))*(m1)))))), vl1);
        s460 = __riscv_vget_f32m1(r170, 0);
        s461 = __riscv_vget_f32m1(r170, 1);
