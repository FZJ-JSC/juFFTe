...
void dft7b_r32_(float *Y, float *X, float *TW1, int64_t *lp1, int64_t *mp1) {
    float a1138, a1139, a1140, a1141, a1142, a1143, a1144, a1145, 
            a1146, a1147, a1148, a1149;
    int64_t a1136, a1137, j1, l1, m1;
    ...
    vfloat32m1_t  s734, s735, s736, s737, s738, s739, s740, s741, 
    ...
    for(int j2 = 0; j2 < (l1 - 1); j2++) {
        ...
        for(int j2 = 0; j2 < l1; j2++) {
            for (size_t k1 = 0; k1 < m1; k1 += vl1) {
                ...
                a1136 = (k1 + ((j1)*(m1)));
                r113 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(a1136))), vl1);
                s734 = __riscv_vget_f32m1(r113, 0);
                s735 = __riscv_vget_f32m1(r113, 1);
                r114 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((a1136 + ((l1)*(m1)))))), vl1);
                s736 = __riscv_vget_f32m1(r114, 0);
                s737 = __riscv_vget_f32m1(r114, 1);
                r115 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((a1136 + ((((2)*(l1)))*(m1)))))), vl1);
                s738 = __riscv_vget_f32m1(r115, 0);
                s739 = __riscv_vget_f32m1(r115, 1);
                r116 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((a1136 + ((((3)*(l1)))*(m1)))))), vl1);
                s740 = __riscv_vget_f32m1(r116, 0);
                s741 = __riscv_vget_f32m1(r116, 1);
                r117 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((a1136 + ((((4)*(l1)))*(m1)))))), vl1);
                s742 = __riscv_vget_f32m1(r117, 0);
                s743 = __riscv_vget_f32m1(r117, 1);
                r118 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((a1136 + ((((5)*(l1)))*(m1)))))), vl1);
                s744 = __riscv_vget_f32m1(r118, 0);
                s745 = __riscv_vget_f32m1(r118, 1);
                r119 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((a1136 + ((((6)*(l1)))*(m1)))))), vl1);
                s746 = __riscv_vget_f32m1(r119, 0);
                s747 = __riscv_vget_f32m1(r119, 1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((7)*(j1)))*(m1)))))), r120, vl1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((7)*(j1)))*(m1)) + m1)))), r121, vl1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((7)*(j1)))*(m1)) + ((2)*(m1)))))), r122, vl1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((7)*(j1)))*(m1)) + ((3)*(m1)))))), r123, vl1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((7)*(j1)))*(m1)) + ((4)*(m1)))))), r124, vl1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((7)*(j1)))*(m1)) + ((5)*(m1)))))), r125, vl1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((7)*(j1)))*(m1)) + ((6)*(m1)))))), r126, vl1);
            }
        }
    }
}
