...
void dft4c_(double *Y, double *X, int *lp1, int *mp1) {
    ...
    vfloat64m1_t  s57, s58, s59, s60, s61, s62, s63, s64, 
...
#pragma GCC unroll 2
    for (size_t k1 = 0; k1 < m1; k1 += vl1) {
        ...
        r65 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*(k1))), vl1);
        s57 = __riscv_vget_f64m1(r65, 0);
        s58 = __riscv_vget_f64m1(r65, 1);
        r66 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((k1 + ((l1)*(m1)))))), vl1);
        s59 = __riscv_vget_f64m1(r66, 0);
        s60 = __riscv_vget_f64m1(r66, 1);
        r67 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((k1 + ((((2)*(l1)))*(m1)))))), vl1);
        s61 = __riscv_vget_f64m1(r67, 0);
        s62 = __riscv_vget_f64m1(r67, 1);
        r68 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((k1 + ((((3)*(l1)))*(m1)))))), vl1);
        s63 = __riscv_vget_f64m1(r68, 0);
        s64 = __riscv_vget_f64m1(r68, 1);
