...
void dft16c_r32_(float *Y, float *X, int64_t *lp1, int64_t *mp1) {
    int64_t l1, m1;
    ...
    vfloat32m1_t  a1338, a1339, a1340, a1341, a1342, a1343, a1344, a1345, 
    ...
    for (size_t k1 = 0; k1 < m1; k1 += vl1) {
        ...
        r257 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(k1))), vl1);
        s722 = __riscv_vget_f32m1(r257, 0);
        s723 = __riscv_vget_f32m1(r257, 1);
        r258 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((l1)*(m1)))))), vl1);
        s724 = __riscv_vget_f32m1(r258, 0);
        s725 = __riscv_vget_f32m1(r258, 1);
        r259 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((2)*(l1)))*(m1)))))), vl1);
        s726 = __riscv_vget_f32m1(r259, 0);
        s727 = __riscv_vget_f32m1(r259, 1);
        r260 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((3)*(l1)))*(m1)))))), vl1);
        s728 = __riscv_vget_f32m1(r260, 0);
        s729 = __riscv_vget_f32m1(r260, 1);
        r261 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((4)*(l1)))*(m1)))))), vl1);
        s730 = __riscv_vget_f32m1(r261, 0);
        s731 = __riscv_vget_f32m1(r261, 1);
        r262 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((5)*(l1)))*(m1)))))), vl1);
        s732 = __riscv_vget_f32m1(r262, 0);
        s733 = __riscv_vget_f32m1(r262, 1);
        r263 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((6)*(l1)))*(m1)))))), vl1);
        s734 = __riscv_vget_f32m1(r263, 0);
        s735 = __riscv_vget_f32m1(r263, 1);
        r264 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((7)*(l1)))*(m1)))))), vl1);
        s736 = __riscv_vget_f32m1(r264, 0);
        s737 = __riscv_vget_f32m1(r264, 1);
        r265 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((8)*(l1)))*(m1)))))), vl1);
        s738 = __riscv_vget_f32m1(r265, 0);
        s739 = __riscv_vget_f32m1(r265, 1);
        r266 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((9)*(l1)))*(m1)))))), vl1);
        s740 = __riscv_vget_f32m1(r266, 0);
        s741 = __riscv_vget_f32m1(r266, 1);
        r267 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((10)*(l1)))*(m1)))))), vl1);
        s742 = __riscv_vget_f32m1(r267, 0);
        s743 = __riscv_vget_f32m1(r267, 1);
        r268 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((11)*(l1)))*(m1)))))), vl1);
        s744 = __riscv_vget_f32m1(r268, 0);
        s745 = __riscv_vget_f32m1(r268, 1);
        r269 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((12)*(l1)))*(m1)))))), vl1);
        s746 = __riscv_vget_f32m1(r269, 0);
        s747 = __riscv_vget_f32m1(r269, 1);
        r270 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((13)*(l1)))*(m1)))))), vl1);
        s748 = __riscv_vget_f32m1(r270, 0);
        s749 = __riscv_vget_f32m1(r270, 1);
        r271 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((14)*(l1)))*(m1)))))), vl1);
        s750 = __riscv_vget_f32m1(r271, 0);
        s751 = __riscv_vget_f32m1(r271, 1);
        r272 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((15)*(l1)))*(m1)))))), vl1);
        s752 = __riscv_vget_f32m1(r272, 0);
        s753 = __riscv_vget_f32m1(r272, 1);
