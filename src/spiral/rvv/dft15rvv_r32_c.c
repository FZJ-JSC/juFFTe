...
void dft15c_r32_(float *Y, float *X, int64_t *lp1, int64_t *mp1) {
    int64_t l1, m1;
    ...
    vfloat32m1_t  s872, s873, s874, s875, s876, s877, s878, s879, 
    ...
    for (size_t k1 = 0; k1 < m1; k1 += vl1) {
        ...
        r241 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(k1))), vl1);
        s872 = __riscv_vget_f32m1(r241, 0);
        s873 = __riscv_vget_f32m1(r241, 1);
        r242 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((l1)*(m1)))))), vl1);
        s874 = __riscv_vget_f32m1(r242, 0);
        s875 = __riscv_vget_f32m1(r242, 1);
        r243 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((2)*(l1)))*(m1)))))), vl1);
        s876 = __riscv_vget_f32m1(r243, 0);
        s877 = __riscv_vget_f32m1(r243, 1);
        r244 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((3)*(l1)))*(m1)))))), vl1);
        s878 = __riscv_vget_f32m1(r244, 0);
        s879 = __riscv_vget_f32m1(r244, 1);
        r245 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((4)*(l1)))*(m1)))))), vl1);
        s880 = __riscv_vget_f32m1(r245, 0);
        s881 = __riscv_vget_f32m1(r245, 1);
        r246 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((5)*(l1)))*(m1)))))), vl1);
        s882 = __riscv_vget_f32m1(r246, 0);
        s883 = __riscv_vget_f32m1(r246, 1);
        r247 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((6)*(l1)))*(m1)))))), vl1);
        s884 = __riscv_vget_f32m1(r247, 0);
        s885 = __riscv_vget_f32m1(r247, 1);
        r248 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((7)*(l1)))*(m1)))))), vl1);
        s886 = __riscv_vget_f32m1(r248, 0);
        s887 = __riscv_vget_f32m1(r248, 1);
        r249 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((8)*(l1)))*(m1)))))), vl1);
        s888 = __riscv_vget_f32m1(r249, 0);
        s889 = __riscv_vget_f32m1(r249, 1);
        r250 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((9)*(l1)))*(m1)))))), vl1);
        s890 = __riscv_vget_f32m1(r250, 0);
        s891 = __riscv_vget_f32m1(r250, 1);
        r251 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((10)*(l1)))*(m1)))))), vl1);
        s892 = __riscv_vget_f32m1(r251, 0);
        s893 = __riscv_vget_f32m1(r251, 1);
        r252 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((11)*(l1)))*(m1)))))), vl1);
        s894 = __riscv_vget_f32m1(r252, 0);
        s895 = __riscv_vget_f32m1(r252, 1);
        r253 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((12)*(l1)))*(m1)))))), vl1);
        s896 = __riscv_vget_f32m1(r253, 0);
        s897 = __riscv_vget_f32m1(r253, 1);
        r254 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((13)*(l1)))*(m1)))))), vl1);
        s898 = __riscv_vget_f32m1(r254, 0);
        s899 = __riscv_vget_f32m1(r254, 1);
        r255 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((14)*(l1)))*(m1)))))), vl1);
        s900 = __riscv_vget_f32m1(r255, 0);
        s901 = __riscv_vget_f32m1(r255, 1);
