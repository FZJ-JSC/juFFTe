...
void dft6c_r32_(float *Y, float *X, int64_t *lp1, int64_t *mp1) {
    int64_t l1, m1;
    vfloat32m1x2_t r100, r101, r102, r103, r104, r105, r106, r107, 
            r108, r97, r98, r99, rvvx2_10, rvvx2_11, rvvx2_12, rvvx2_7, 
            rvvx2_8, rvvx2_9;
    vfloat32m1_t  s205, s206, s207, s208, s209, s210, s211, s212, 
    ...
    for (size_t k1 = 0; k1 < m1; k1 += vl1) {
        ...
        r97 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(k1))), vl1);
        s205 = __riscv_vget_f32m1(r97, 0);
        s206 = __riscv_vget_f32m1(r97, 1);
        r98 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((l1)*(m1)))))), vl1);
        s207 = __riscv_vget_f32m1(r98, 0);
        s208 = __riscv_vget_f32m1(r98, 1);
        r99 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((2)*(l1)))*(m1)))))), vl1);
        s209 = __riscv_vget_f32m1(r99, 0);
        s210 = __riscv_vget_f32m1(r99, 1);
        r100 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((3)*(l1)))*(m1)))))), vl1);
        s211 = __riscv_vget_f32m1(r100, 0);
        s212 = __riscv_vget_f32m1(r100, 1);
        r101 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((4)*(l1)))*(m1)))))), vl1);
        s213 = __riscv_vget_f32m1(r101, 0);
        s214 = __riscv_vget_f32m1(r101, 1);
        r102 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((5)*(l1)))*(m1)))))), vl1);
        s215 = __riscv_vget_f32m1(r102, 0);
        s216 = __riscv_vget_f32m1(r102, 1);
