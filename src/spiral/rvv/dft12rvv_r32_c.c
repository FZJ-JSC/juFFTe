...
void dft12c_r32_(float *Y, float *X, int64_t *lp1, int64_t *mp1) {
    int64_t l1, m1;
    ...
    vfloat32m1_t  s794, s795, s796, s797, s798, s799, s800, s801, 
    ...
    for (size_t k1 = 0; k1 < m1; k1 += vl1) {
        ...
        r193 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(k1))), vl1);
        s794 = __riscv_vget_f32m1(r193, 0);
        s795 = __riscv_vget_f32m1(r193, 1);
        r194 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((l1)*(m1)))))), vl1);
        s796 = __riscv_vget_f32m1(r194, 0);
        s797 = __riscv_vget_f32m1(r194, 1);
        r195 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((2)*(l1)))*(m1)))))), vl1);
        s798 = __riscv_vget_f32m1(r195, 0);
        s799 = __riscv_vget_f32m1(r195, 1);
        r196 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((3)*(l1)))*(m1)))))), vl1);
        s800 = __riscv_vget_f32m1(r196, 0);
        s801 = __riscv_vget_f32m1(r196, 1);
        r197 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((4)*(l1)))*(m1)))))), vl1);
        s802 = __riscv_vget_f32m1(r197, 0);
        s803 = __riscv_vget_f32m1(r197, 1);
        r198 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((5)*(l1)))*(m1)))))), vl1);
        s804 = __riscv_vget_f32m1(r198, 0);
        s805 = __riscv_vget_f32m1(r198, 1);
        r199 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((6)*(l1)))*(m1)))))), vl1);
        s806 = __riscv_vget_f32m1(r199, 0);
        s807 = __riscv_vget_f32m1(r199, 1);
        r200 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((7)*(l1)))*(m1)))))), vl1);
        s808 = __riscv_vget_f32m1(r200, 0);
        s809 = __riscv_vget_f32m1(r200, 1);
        r201 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((8)*(l1)))*(m1)))))), vl1);
        s810 = __riscv_vget_f32m1(r201, 0);
        s811 = __riscv_vget_f32m1(r201, 1);
        r202 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((9)*(l1)))*(m1)))))), vl1);
        s812 = __riscv_vget_f32m1(r202, 0);
        s813 = __riscv_vget_f32m1(r202, 1);
        r203 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((10)*(l1)))*(m1)))))), vl1);
        s814 = __riscv_vget_f32m1(r203, 0);
        s815 = __riscv_vget_f32m1(r203, 1);
        r204 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((11)*(l1)))*(m1)))))), vl1);
        s816 = __riscv_vget_f32m1(r204, 0);
        s817 = __riscv_vget_f32m1(r204, 1);
