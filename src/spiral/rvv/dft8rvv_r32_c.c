...
void dft8c_r32_(float *Y, float *X, int64_t *lp1, int64_t *mp1) {
    int64_t l1, m1;
    ...
    vfloat32m1_t  a353, a354, a355, a356, s173, s174, s175, s176, 
    ...
    for (size_t k1 = 0; k1 < m1; k1 += vl1) {
        ...
        r129 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(k1))), vl1);
        s173 = __riscv_vget_f32m1(r129, 0);
        s174 = __riscv_vget_f32m1(r129, 1);
        r130 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((l1)*(m1)))))), vl1);
        s175 = __riscv_vget_f32m1(r130, 0);
        s176 = __riscv_vget_f32m1(r130, 1);
        r131 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((2)*(l1)))*(m1)))))), vl1);
        s177 = __riscv_vget_f32m1(r131, 0);
        s178 = __riscv_vget_f32m1(r131, 1);
        r132 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((3)*(l1)))*(m1)))))), vl1);
        s179 = __riscv_vget_f32m1(r132, 0);
        s180 = __riscv_vget_f32m1(r132, 1);
        r133 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((4)*(l1)))*(m1)))))), vl1);
        s181 = __riscv_vget_f32m1(r133, 0);
        s182 = __riscv_vget_f32m1(r133, 1);
        r134 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((5)*(l1)))*(m1)))))), vl1);
        s183 = __riscv_vget_f32m1(r134, 0);
        s184 = __riscv_vget_f32m1(r134, 1);
        r135 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((6)*(l1)))*(m1)))))), vl1);
        s185 = __riscv_vget_f32m1(r135, 0);
        s186 = __riscv_vget_f32m1(r135, 1);
        r136 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((7)*(l1)))*(m1)))))), vl1);
        s187 = __riscv_vget_f32m1(r136, 0);
        s188 = __riscv_vget_f32m1(r136, 1);
