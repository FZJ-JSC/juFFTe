...
void dft9c_r32_(float *Y, float *X, int64_t *lp1, int64_t *mp1) {
    int64_t l1, m1;
    ...
    vfloat32m1_t  s347, s348, s349, s350, s351, s352, s353, s354, 
    ...
    for (size_t k1 = 0; k1 < m1; k1 += vl1) {
        ...
        r145 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(k1))), vl1);
        s347 = __riscv_vget_f32m1(r145, 0);
        s348 = __riscv_vget_f32m1(r145, 1);
        r146 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((l1)*(m1)))))), vl1);
        s349 = __riscv_vget_f32m1(r146, 0);
        s350 = __riscv_vget_f32m1(r146, 1);
        r147 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((2)*(l1)))*(m1)))))), vl1);
        s351 = __riscv_vget_f32m1(r147, 0);
        s352 = __riscv_vget_f32m1(r147, 1);
        r148 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((3)*(l1)))*(m1)))))), vl1);
        s353 = __riscv_vget_f32m1(r148, 0);
        s354 = __riscv_vget_f32m1(r148, 1);
        r149 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((4)*(l1)))*(m1)))))), vl1);
        s355 = __riscv_vget_f32m1(r149, 0);
        s356 = __riscv_vget_f32m1(r149, 1);
        r150 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((5)*(l1)))*(m1)))))), vl1);
        s357 = __riscv_vget_f32m1(r150, 0);
        s358 = __riscv_vget_f32m1(r150, 1);
        r151 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((6)*(l1)))*(m1)))))), vl1);
        s359 = __riscv_vget_f32m1(r151, 0);
        s360 = __riscv_vget_f32m1(r151, 1);
        r152 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((7)*(l1)))*(m1)))))), vl1);
        s361 = __riscv_vget_f32m1(r152, 0);
        s362 = __riscv_vget_f32m1(r152, 1);
        r153 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((8)*(l1)))*(m1)))))), vl1);
        s363 = __riscv_vget_f32m1(r153, 0);
        s364 = __riscv_vget_f32m1(r153, 1);
