...
void dft15a_(double *Y, double *X, double *TW1, int *lp1) {
    int l1;
    double *a1724;
    vfloat64m1x2_t r106, r107, r108, r109, r110, r111, r112, r113, 
            r114, r115, r116, r117, r118, r119, r120;
    vfloat64m1_t  a1725, a1726, a1727, a1728, a1729, a1730, a1731, a1732, 
    ...
    for (size_t j1 = 0; j1 < l1; j1 += vl1) {
        ...
        r106 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*(j1))), vl1);
        s986 = __riscv_vget_f64m1(r106, 0);
        s987 = __riscv_vget_f64m1(r106, 1);
        r107 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + l1)))), vl1);
        s988 = __riscv_vget_f64m1(r107, 0);
        s989 = __riscv_vget_f64m1(r107, 1);
        r108 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((2)*(l1)))))), vl1);
        s990 = __riscv_vget_f64m1(r108, 0);
        s991 = __riscv_vget_f64m1(r108, 1);
        r109 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((3)*(l1)))))), vl1);
        s992 = __riscv_vget_f64m1(r109, 0);
        s993 = __riscv_vget_f64m1(r109, 1);
        r110 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((4)*(l1)))))), vl1);
        s994 = __riscv_vget_f64m1(r110, 0);
        s995 = __riscv_vget_f64m1(r110, 1);
        r111 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((5)*(l1)))))), vl1);
        s996 = __riscv_vget_f64m1(r111, 0);
        s997 = __riscv_vget_f64m1(r111, 1);
        r112 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((6)*(l1)))))), vl1);
        s998 = __riscv_vget_f64m1(r112, 0);
        s999 = __riscv_vget_f64m1(r112, 1);
        r113 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((7)*(l1)))))), vl1);
        s1000 = __riscv_vget_f64m1(r113, 0);
        s1001 = __riscv_vget_f64m1(r113, 1);
        r114 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((8)*(l1)))))), vl1);
        s1002 = __riscv_vget_f64m1(r114, 0);
        s1003 = __riscv_vget_f64m1(r114, 1);
        r115 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((9)*(l1)))))), vl1);
        s1004 = __riscv_vget_f64m1(r115, 0);
        s1005 = __riscv_vget_f64m1(r115, 1);
        r116 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((10)*(l1)))))), vl1);
        s1006 = __riscv_vget_f64m1(r116, 0);
        s1007 = __riscv_vget_f64m1(r116, 1);
        r117 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((11)*(l1)))))), vl1);
        s1008 = __riscv_vget_f64m1(r117, 0);
        s1009 = __riscv_vget_f64m1(r117, 1);
        r118 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((12)*(l1)))))), vl1);
        s1010 = __riscv_vget_f64m1(r118, 0);
        s1011 = __riscv_vget_f64m1(r118, 1);
        r119 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((13)*(l1)))))), vl1);
        s1012 = __riscv_vget_f64m1(r119, 0);
        s1013 = __riscv_vget_f64m1(r119, 1);
        r120 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((14)*(l1)))))), vl1);
        s1014 = __riscv_vget_f64m1(r120, 0);
        s1015 = __riscv_vget_f64m1(r120, 1);
        ...
        a1724 = (TW1 + ((28)*(j1)));
        a1725 = __riscv_vlse64_v_f64m1(a1724, sizeof(double) * 28, vl1);
        a1726 = __riscv_vlse64_v_f64m1((a1724 + 1), sizeof(double) * 28, vl1);
        ...
        a1727 = __riscv_vlse64_v_f64m1((a1724 + 2), sizeof(double) * 28, vl1);
        a1728 = __riscv_vlse64_v_f64m1((a1724 + 3), sizeof(double) * 28, vl1);
        ...
        a1729 = __riscv_vlse64_v_f64m1((a1724 + 4), sizeof(double) * 28, vl1);
        a1730 = __riscv_vlse64_v_f64m1((a1724 + 5), sizeof(double) * 28, vl1);
        ...
        a1731 = __riscv_vlse64_v_f64m1((a1724 + 6), sizeof(double) * 28, vl1);
        a1732 = __riscv_vlse64_v_f64m1((a1724 + 7), sizeof(double) * 28, vl1);
        ...
        a1733 = __riscv_vlse64_v_f64m1((a1724 + 8), sizeof(double) * 28, vl1);
        a1734 = __riscv_vlse64_v_f64m1((a1724 + 9), sizeof(double) * 28, vl1);
        ...
        a1735 = __riscv_vlse64_v_f64m1((a1724 + 10), sizeof(double) * 28, vl1);
        a1736 = __riscv_vlse64_v_f64m1((a1724 + 11), sizeof(double) * 28, vl1);
        ...
        a1737 = __riscv_vlse64_v_f64m1((a1724 + 12), sizeof(double) * 28, vl1);
        a1738 = __riscv_vlse64_v_f64m1((a1724 + 13), sizeof(double) * 28, vl1);
        ...
        a1739 = __riscv_vlse64_v_f64m1((a1724 + 14), sizeof(double) * 28, vl1);
        a1740 = __riscv_vlse64_v_f64m1((a1724 + 15), sizeof(double) * 28, vl1);
        ...
        a1741 = __riscv_vlse64_v_f64m1((a1724 + 16), sizeof(double) * 28, vl1);
        a1742 = __riscv_vlse64_v_f64m1((a1724 + 17), sizeof(double) * 28, vl1);
        ...
        a1743 = __riscv_vlse64_v_f64m1((a1724 + 18), sizeof(double) * 28, vl1);
        a1744 = __riscv_vlse64_v_f64m1((a1724 + 19), sizeof(double) * 28, vl1);
        ...
        a1745 = __riscv_vlse64_v_f64m1((a1724 + 20), sizeof(double) * 28, vl1);
        a1746 = __riscv_vlse64_v_f64m1((a1724 + 21), sizeof(double) * 28, vl1);
        ...
        a1747 = __riscv_vlse64_v_f64m1((a1724 + 22), sizeof(double) * 28, vl1);
        a1748 = __riscv_vlse64_v_f64m1((a1724 + 23), sizeof(double) * 28, vl1);
        ...
        a1749 = __riscv_vlse64_v_f64m1((a1724 + 24), sizeof(double) * 28, vl1);
        a1750 = __riscv_vlse64_v_f64m1((a1724 + 25), sizeof(double) * 28, vl1);
        ...
        a1751 = __riscv_vlse64_v_f64m1((a1724 + 26), sizeof(double) * 28, vl1);
        a1752 = __riscv_vlse64_v_f64m1((a1724 + 27), sizeof(double) * 28, vl1);
        ...
        __riscv_vsse64((Y + ((30)*(j1))), sizeof(double) * 30, s1052, vl1);
        __riscv_vsse64((1 + Y + ((30)*(j1))), sizeof(double) * 30, s1053, vl1);
        __riscv_vsse64((2 + Y + ((30)*(j1))), sizeof(double) * 30, s1090, vl1);
        __riscv_vsse64((3 + Y + ((30)*(j1))), sizeof(double) * 30, s1091, vl1);
        __riscv_vsse64((4 + Y + ((30)*(j1))), sizeof(double) * 30, s1092, vl1);
        __riscv_vsse64((5 + Y + ((30)*(j1))), sizeof(double) * 30, s1093, vl1);
        __riscv_vsse64((6 + Y + ((30)*(j1))), sizeof(double) * 30, s1094, vl1);
        __riscv_vsse64((7 + Y + ((30)*(j1))), sizeof(double) * 30, s1095, vl1);
        __riscv_vsse64((8 + Y + ((30)*(j1))), sizeof(double) * 30, s1096, vl1);
        __riscv_vsse64((9 + Y + ((30)*(j1))), sizeof(double) * 30, s1097, vl1);
        __riscv_vsse64((10 + Y + ((30)*(j1))), sizeof(double) * 30, s1098, vl1);
        __riscv_vsse64((11 + Y + ((30)*(j1))), sizeof(double) * 30, s1099, vl1);
        __riscv_vsse64((12 + Y + ((30)*(j1))), sizeof(double) * 30, s1100, vl1);
        __riscv_vsse64((13 + Y + ((30)*(j1))), sizeof(double) * 30, s1101, vl1);
        __riscv_vsse64((14 + Y + ((30)*(j1))), sizeof(double) * 30, s1102, vl1);
        __riscv_vsse64((15 + Y + ((30)*(j1))), sizeof(double) * 30, s1103, vl1);
        __riscv_vsse64((16 + Y + ((30)*(j1))), sizeof(double) * 30, s1104, vl1);
        __riscv_vsse64((17 + Y + ((30)*(j1))), sizeof(double) * 30, s1105, vl1);
        __riscv_vsse64((18 + Y + ((30)*(j1))), sizeof(double) * 30, s1106, vl1);
        __riscv_vsse64((19 + Y + ((30)*(j1))), sizeof(double) * 30, s1107, vl1);
        __riscv_vsse64((20 + Y + ((30)*(j1))), sizeof(double) * 30, s1108, vl1);
        __riscv_vsse64((21 + Y + ((30)*(j1))), sizeof(double) * 30, s1109, vl1);
        __riscv_vsse64((22 + Y + ((30)*(j1))), sizeof(double) * 30, s1110, vl1);
        __riscv_vsse64((23 + Y + ((30)*(j1))), sizeof(double) * 30, s1111, vl1);
        __riscv_vsse64((24 + Y + ((30)*(j1))), sizeof(double) * 30, s1112, vl1);
        __riscv_vsse64((25 + Y + ((30)*(j1))), sizeof(double) * 30, s1113, vl1);
        __riscv_vsse64((26 + Y + ((30)*(j1))), sizeof(double) * 30, s1114, vl1);
        __riscv_vsse64((27 + Y + ((30)*(j1))), sizeof(double) * 30, s1115, vl1);
        __riscv_vsse64((28 + Y + ((30)*(j1))), sizeof(double) * 30, s1116, vl1);
        __riscv_vsse64((29 + Y + ((30)*(j1))), sizeof(double) * 30, s1117, vl1);
    }
}
