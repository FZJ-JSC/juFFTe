...
void dft3c_(double *Y, double *X, int *lp1, int *mp1) {
    ...
    vfloat64m1x2_t r49, r50, r51, r52, r53, r54, rvvx2_4, rvvx2_5, 
            rvvx2_6;
    vfloat64m1_t  s65, s66, s67, s68, s69, s70, s71, s72, 
            t125, t126, t127, t128;
    size_t vl1;
    l1 = *(lp1);
    m1 = *(mp1);
#pragma GCC unroll 2
    for (size_t k1 = 0; k1 < m1; k1 += vl1) {
        ...
        r49 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*(k1))), vl1);
        s65 = __riscv_vget_f64m1(r49, 0);
        s66 = __riscv_vget_f64m1(r49, 1);
        r50 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((k1 + ((l1)*(m1)))))), vl1);
        s67 = __riscv_vget_f64m1(r50, 0);
        s68 = __riscv_vget_f64m1(r50, 1);
        r51 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((k1 + ((((2)*(l1)))*(m1)))))), vl1);
        s69 = __riscv_vget_f64m1(r51, 0);
        s70 = __riscv_vget_f64m1(r51, 1);
