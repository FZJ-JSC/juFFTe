...
void dft9a_(double *Y, double *X, double *TW1, int *lp1) {
    int l1;
    double *a804;
    vfloat64m1x2_t r64, r65, r66, r67, r68, r69, r70, r71, 
            r72;
    vfloat64m1_t  a805, a806, a807, a808, a809, a810, a811, a812, 
    ...
    for (size_t j1 = 0; j1 < l1; j1 += vl1) {
        ...
        r64 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*(j1))), vl1);
        s414 = __riscv_vget_f64m1(r64, 0);
        s415 = __riscv_vget_f64m1(r64, 1);
        r65 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + l1)))), vl1);
        s416 = __riscv_vget_f64m1(r65, 0);
        s417 = __riscv_vget_f64m1(r65, 1);
        r66 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((2)*(l1)))))), vl1);
        s418 = __riscv_vget_f64m1(r66, 0);
        s419 = __riscv_vget_f64m1(r66, 1);
        r67 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((3)*(l1)))))), vl1);
        s420 = __riscv_vget_f64m1(r67, 0);
        s421 = __riscv_vget_f64m1(r67, 1);
        r68 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((4)*(l1)))))), vl1);
        s422 = __riscv_vget_f64m1(r68, 0);
        s423 = __riscv_vget_f64m1(r68, 1);
        r69 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((5)*(l1)))))), vl1);
        s424 = __riscv_vget_f64m1(r69, 0);
        s425 = __riscv_vget_f64m1(r69, 1);
        r70 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((6)*(l1)))))), vl1);
        s426 = __riscv_vget_f64m1(r70, 0);
        s427 = __riscv_vget_f64m1(r70, 1);
        r71 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((7)*(l1)))))), vl1);
        s428 = __riscv_vget_f64m1(r71, 0);
        s429 = __riscv_vget_f64m1(r71, 1);
        r72 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((8)*(l1)))))), vl1);
        s430 = __riscv_vget_f64m1(r72, 0);
        s431 = __riscv_vget_f64m1(r72, 1);
        ...
        a804 = (TW1 + ((16)*(j1)));
        a805 = __riscv_vlse64_v_f64m1(a804, sizeof(double) * 16, vl1);
        a806 = __riscv_vlse64_v_f64m1((a804 + 1), sizeof(double) * 16, vl1);
        ...
        a807 = __riscv_vlse64_v_f64m1((a804 + 2), sizeof(double) * 16, vl1);
        a808 = __riscv_vlse64_v_f64m1((a804 + 3), sizeof(double) * 16, vl1);
        ...
        a809 = __riscv_vlse64_v_f64m1((a804 + 4), sizeof(double) * 16, vl1);
        a810 = __riscv_vlse64_v_f64m1((a804 + 5), sizeof(double) * 16, vl1);
        ...
        a811 = __riscv_vlse64_v_f64m1((a804 + 6), sizeof(double) * 16, vl1);
        a812 = __riscv_vlse64_v_f64m1((a804 + 7), sizeof(double) * 16, vl1);
        ...
        a813 = __riscv_vlse64_v_f64m1((a804 + 8), sizeof(double) * 16, vl1);
        a814 = __riscv_vlse64_v_f64m1((a804 + 9), sizeof(double) * 16, vl1);
        ...
        a815 = __riscv_vlse64_v_f64m1((a804 + 10), sizeof(double) * 16, vl1);
        a816 = __riscv_vlse64_v_f64m1((a804 + 11), sizeof(double) * 16, vl1);
        ...
        a817 = __riscv_vlse64_v_f64m1((a804 + 12), sizeof(double) * 16, vl1);
        a818 = __riscv_vlse64_v_f64m1((a804 + 13), sizeof(double) * 16, vl1);
        ...
        a819 = __riscv_vlse64_v_f64m1((a804 + 14), sizeof(double) * 16, vl1);
        a820 = __riscv_vlse64_v_f64m1((a804 + 15), sizeof(double) * 16, vl1);
        ...
        __riscv_vsse64((Y + ((18)*(j1))), sizeof(double) * 18, s448, vl1);
        __riscv_vsse64((1 + Y + ((18)*(j1))), sizeof(double) * 18, s449, vl1);
        __riscv_vsse64((2 + Y + ((18)*(j1))), sizeof(double) * 18, s470, vl1);
        __riscv_vsse64((3 + Y + ((18)*(j1))), sizeof(double) * 18, s471, vl1);
        __riscv_vsse64((4 + Y + ((18)*(j1))), sizeof(double) * 18, s472, vl1);
        __riscv_vsse64((5 + Y + ((18)*(j1))), sizeof(double) * 18, s473, vl1);
        __riscv_vsse64((6 + Y + ((18)*(j1))), sizeof(double) * 18, s474, vl1);
        __riscv_vsse64((7 + Y + ((18)*(j1))), sizeof(double) * 18, s475, vl1);
        __riscv_vsse64((8 + Y + ((18)*(j1))), sizeof(double) * 18, s476, vl1);
        __riscv_vsse64((9 + Y + ((18)*(j1))), sizeof(double) * 18, s477, vl1);
        __riscv_vsse64((10 + Y + ((18)*(j1))), sizeof(double) * 18, s478, vl1);
        __riscv_vsse64((11 + Y + ((18)*(j1))), sizeof(double) * 18, s479, vl1);
        __riscv_vsse64((12 + Y + ((18)*(j1))), sizeof(double) * 18, s480, vl1);
        __riscv_vsse64((13 + Y + ((18)*(j1))), sizeof(double) * 18, s481, vl1);
        __riscv_vsse64((14 + Y + ((18)*(j1))), sizeof(double) * 18, s482, vl1);
        __riscv_vsse64((15 + Y + ((18)*(j1))), sizeof(double) * 18, s483, vl1);
        __riscv_vsse64((16 + Y + ((18)*(j1))), sizeof(double) * 18, s484, vl1);
        __riscv_vsse64((17 + Y + ((18)*(j1))), sizeof(double) * 18, s485, vl1);
    }
}
