...
void dft16a_r32_(float *Y, float *X, float *TW1, int64_t *lp1) {
    int64_t l1;
    float *a1978;
    vfloat32m1x2_t r113, r114, r115, r116, r117, r118, r119, r120, 
            r121, r122, r123, r124, r125, r126, r127, r128;
    vfloat32m1_t  a1970, a1971, a1972, a1973, a1974, a1975, a1976, a1977, 
    ...
    for (size_t j1 = 0; j1 < l1; j1 += vl1) {
        ...
        r113 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(j1))), vl1);
        s844 = __riscv_vget_f32m1(r113, 0);
        s845 = __riscv_vget_f32m1(r113, 1);
        r114 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + l1)))), vl1);
        s846 = __riscv_vget_f32m1(r114, 0);
        s847 = __riscv_vget_f32m1(r114, 1);
        r115 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((2)*(l1)))))), vl1);
        s848 = __riscv_vget_f32m1(r115, 0);
        s849 = __riscv_vget_f32m1(r115, 1);
        r116 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((3)*(l1)))))), vl1);
        s850 = __riscv_vget_f32m1(r116, 0);
        s851 = __riscv_vget_f32m1(r116, 1);
        r117 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((4)*(l1)))))), vl1);
        s852 = __riscv_vget_f32m1(r117, 0);
        s853 = __riscv_vget_f32m1(r117, 1);
        r118 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((5)*(l1)))))), vl1);
        s854 = __riscv_vget_f32m1(r118, 0);
        s855 = __riscv_vget_f32m1(r118, 1);
        r119 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((6)*(l1)))))), vl1);
        s856 = __riscv_vget_f32m1(r119, 0);
        s857 = __riscv_vget_f32m1(r119, 1);
        r120 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((7)*(l1)))))), vl1);
        s858 = __riscv_vget_f32m1(r120, 0);
        s859 = __riscv_vget_f32m1(r120, 1);
        r121 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((8)*(l1)))))), vl1);
        s860 = __riscv_vget_f32m1(r121, 0);
        s861 = __riscv_vget_f32m1(r121, 1);
        r122 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((9)*(l1)))))), vl1);
        s862 = __riscv_vget_f32m1(r122, 0);
        s863 = __riscv_vget_f32m1(r122, 1);
        r123 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((10)*(l1)))))), vl1);
        s864 = __riscv_vget_f32m1(r123, 0);
        s865 = __riscv_vget_f32m1(r123, 1);
        r124 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((11)*(l1)))))), vl1);
        s866 = __riscv_vget_f32m1(r124, 0);
        s867 = __riscv_vget_f32m1(r124, 1);
        r125 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((12)*(l1)))))), vl1);
        s868 = __riscv_vget_f32m1(r125, 0);
        s869 = __riscv_vget_f32m1(r125, 1);
        r126 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((13)*(l1)))))), vl1);
        s870 = __riscv_vget_f32m1(r126, 0);
        s871 = __riscv_vget_f32m1(r126, 1);
        r127 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((14)*(l1)))))), vl1);
        s872 = __riscv_vget_f32m1(r127, 0);
        s873 = __riscv_vget_f32m1(r127, 1);
        r128 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((15)*(l1)))))), vl1);
        s874 = __riscv_vget_f32m1(r128, 0);
        s875 = __riscv_vget_f32m1(r128, 1);
        ...
        a1978 = (TW1 + ((30)*(j1)));
        a1979 = __riscv_vlse32_v_f32m1(a1978, sizeof(double) * 30, vl1);
        a1980 = __riscv_vlse32_v_f32m1((a1978 + 1), sizeof(double) * 30, vl1);
        ...
        a1981 = __riscv_vlse32_v_f32m1((a1978 + 2), sizeof(double) * 30, vl1);
        a1982 = __riscv_vlse32_v_f32m1((a1978 + 3), sizeof(double) * 30, vl1);
        ...
        a1983 = __riscv_vlse32_v_f32m1((a1978 + 4), sizeof(double) * 30, vl1);
        a1984 = __riscv_vlse32_v_f32m1((a1978 + 5), sizeof(double) * 30, vl1);
        ...
        a1985 = __riscv_vlse32_v_f32m1((a1978 + 6), sizeof(double) * 30, vl1);
        a1986 = __riscv_vlse32_v_f32m1((a1978 + 7), sizeof(double) * 30, vl1);
        ...
        a1987 = __riscv_vlse32_v_f32m1((a1978 + 8), sizeof(double) * 30, vl1);
        a1988 = __riscv_vlse32_v_f32m1((a1978 + 9), sizeof(double) * 30, vl1);
        ...
        a1989 = __riscv_vlse32_v_f32m1((a1978 + 10), sizeof(double) * 30, vl1);
        a1990 = __riscv_vlse32_v_f32m1((a1978 + 11), sizeof(double) * 30, vl1);
        ...
        a1991 = __riscv_vlse32_v_f32m1((a1978 + 12), sizeof(double) * 30, vl1);
        a1992 = __riscv_vlse32_v_f32m1((a1978 + 13), sizeof(double) * 30, vl1);
        ...
        a1993 = __riscv_vlse32_v_f32m1((a1978 + 14), sizeof(double) * 30, vl1);
        a1994 = __riscv_vlse32_v_f32m1((a1978 + 15), sizeof(double) * 30, vl1);
        ...
        a1995 = __riscv_vlse32_v_f32m1((a1978 + 16), sizeof(double) * 30, vl1);
        a1996 = __riscv_vlse32_v_f32m1((a1978 + 17), sizeof(double) * 30, vl1);
        ...
        a1997 = __riscv_vlse32_v_f32m1((a1978 + 18), sizeof(double) * 30, vl1);
        a1998 = __riscv_vlse32_v_f32m1((a1978 + 19), sizeof(double) * 30, vl1);
        ...
        a1999 = __riscv_vlse32_v_f32m1((a1978 + 20), sizeof(double) * 30, vl1);
        a2000 = __riscv_vlse32_v_f32m1((a1978 + 21), sizeof(double) * 30, vl1);
        ...
        a2001 = __riscv_vlse32_v_f32m1((a1978 + 22), sizeof(double) * 30, vl1);
        a2002 = __riscv_vlse32_v_f32m1((a1978 + 23), sizeof(double) * 30, vl1);
        ...
        a2003 = __riscv_vlse32_v_f32m1((a1978 + 24), sizeof(double) * 30, vl1);
        a2004 = __riscv_vlse32_v_f32m1((a1978 + 25), sizeof(double) * 30, vl1);
        ...
        a2005 = __riscv_vlse32_v_f32m1((a1978 + 26), sizeof(double) * 30, vl1);
        a2006 = __riscv_vlse32_v_f32m1((a1978 + 27), sizeof(double) * 30, vl1);
        ...
        a2007 = __riscv_vlse32_v_f32m1((a1978 + 28), sizeof(double) * 30, vl1);
        a2008 = __riscv_vlse32_v_f32m1((a1978 + 29), sizeof(double) * 30, vl1);
        ...
        __riscv_vsse32((Y + ((32)*(j1))), sizeof(double) * 32, s892, vl1);
        __riscv_vsse32((1 + Y + ((32)*(j1))), sizeof(double) * 32, s893, vl1);
        __riscv_vsse32((2 + Y + ((32)*(j1))), sizeof(double) * 32, s924, vl1);
        __riscv_vsse32((3 + Y + ((32)*(j1))), sizeof(double) * 32, s925, vl1);
        __riscv_vsse32((4 + Y + ((32)*(j1))), sizeof(double) * 32, s926, vl1);
        __riscv_vsse32((5 + Y + ((32)*(j1))), sizeof(double) * 32, s927, vl1);
        __riscv_vsse32((6 + Y + ((32)*(j1))), sizeof(double) * 32, s928, vl1);
        __riscv_vsse32((7 + Y + ((32)*(j1))), sizeof(double) * 32, s929, vl1);
        __riscv_vsse32((8 + Y + ((32)*(j1))), sizeof(double) * 32, s930, vl1);
        __riscv_vsse32((9 + Y + ((32)*(j1))), sizeof(double) * 32, s931, vl1);
        __riscv_vsse32((10 + Y + ((32)*(j1))), sizeof(double) * 32, s932, vl1);
        __riscv_vsse32((11 + Y + ((32)*(j1))), sizeof(double) * 32, s933, vl1);
        __riscv_vsse32((12 + Y + ((32)*(j1))), sizeof(double) * 32, s934, vl1);
        __riscv_vsse32((13 + Y + ((32)*(j1))), sizeof(double) * 32, s935, vl1);
        __riscv_vsse32((14 + Y + ((32)*(j1))), sizeof(double) * 32, s936, vl1);
        __riscv_vsse32((15 + Y + ((32)*(j1))), sizeof(double) * 32, s937, vl1);
        __riscv_vsse32((16 + Y + ((32)*(j1))), sizeof(double) * 32, s938, vl1);
        __riscv_vsse32((17 + Y + ((32)*(j1))), sizeof(double) * 32, s939, vl1);
        __riscv_vsse32((18 + Y + ((32)*(j1))), sizeof(double) * 32, s940, vl1);
        __riscv_vsse32((19 + Y + ((32)*(j1))), sizeof(double) * 32, s941, vl1);
        __riscv_vsse32((20 + Y + ((32)*(j1))), sizeof(double) * 32, s942, vl1);
        __riscv_vsse32((21 + Y + ((32)*(j1))), sizeof(double) * 32, s943, vl1);
        __riscv_vsse32((22 + Y + ((32)*(j1))), sizeof(double) * 32, s944, vl1);
        __riscv_vsse32((23 + Y + ((32)*(j1))), sizeof(double) * 32, s945, vl1);
        __riscv_vsse32((24 + Y + ((32)*(j1))), sizeof(double) * 32, s946, vl1);
        __riscv_vsse32((25 + Y + ((32)*(j1))), sizeof(double) * 32, s947, vl1);
        __riscv_vsse32((26 + Y + ((32)*(j1))), sizeof(double) * 32, s948, vl1);
        __riscv_vsse32((27 + Y + ((32)*(j1))), sizeof(double) * 32, s949, vl1);
        __riscv_vsse32((28 + Y + ((32)*(j1))), sizeof(double) * 32, s950, vl1);
        __riscv_vsse32((29 + Y + ((32)*(j1))), sizeof(double) * 32, s951, vl1);
        __riscv_vsse32((30 + Y + ((32)*(j1))), sizeof(double) * 32, s952, vl1);
        __riscv_vsse32((31 + Y + ((32)*(j1))), sizeof(double) * 32, s953, vl1);
    }
}
