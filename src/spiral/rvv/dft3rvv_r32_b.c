...
void dft3b_r32_(float *Y, float *X, float *TW1, int64_t *lp1, int64_t *mp1) {
    float a213, a214, a215, a216;
    int64_t a211, a212, j1, l1, m1;
    vfloat32m1x2_t r49, r50, r51, r52, r53, r54, rvvx2_4, rvvx2_5, 
            rvvx2_6;
    vfloat32m1_t  s77, s78, s79, s80, s81, s82, s83, s84, 
    ...
    for(int j2 = 0; j2 < (l1 - 1); j2++) {
        ...
        for(int j2 = 0; j2 < l1; j2++) {
            for (size_t k1 = 0; k1 < m1; k1 += vl1) {
                ...
                a211 = (k1 + ((j1)*(m1)));
                r49 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(a211))), vl1);
                s77 = __riscv_vget_f32m1(r49, 0);
                s78 = __riscv_vget_f32m1(r49, 1);
                r50 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((a211 + ((l1)*(m1)))))), vl1);
                s79 = __riscv_vget_f32m1(r50, 0);
                s80 = __riscv_vget_f32m1(r50, 1);
                r51 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((a211 + ((((2)*(l1)))*(m1)))))), vl1);
                s81 = __riscv_vget_f32m1(r51, 0);
                s82 = __riscv_vget_f32m1(r51, 1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((3)*(j1)))*(m1)))))), r52, vl1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((3)*(j1)))*(m1)) + m1)))), r53, vl1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((3)*(j1)))*(m1)) + ((2)*(m1)))))), r54, vl1);
            }
        }
    }
}
