...
void dft7c_(double *Y, double *X, int *lp1, int *mp1) {
    ...
    vfloat64m1_t  s698, s699, s700, s701, s702, s703, s704, s705, 
    ...
    for (size_t k1 = 0; k1 < m1; k1 += vl1) {
        ...
        r113 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*(k1))), vl1);
        s698 = __riscv_vget_f64m1(r113, 0);
        s699 = __riscv_vget_f64m1(r113, 1);
        r114 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((k1 + ((l1)*(m1)))))), vl1);
        s700 = __riscv_vget_f64m1(r114, 0);
        s701 = __riscv_vget_f64m1(r114, 1);
        r115 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((k1 + ((((2)*(l1)))*(m1)))))), vl1);
        s702 = __riscv_vget_f64m1(r115, 0);
        s703 = __riscv_vget_f64m1(r115, 1);
        r116 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((k1 + ((((3)*(l1)))*(m1)))))), vl1);
        s704 = __riscv_vget_f64m1(r116, 0);
        s705 = __riscv_vget_f64m1(r116, 1);
        r117 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((k1 + ((((4)*(l1)))*(m1)))))), vl1);
        s706 = __riscv_vget_f64m1(r117, 0);
        s707 = __riscv_vget_f64m1(r117, 1);
        r118 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((k1 + ((((5)*(l1)))*(m1)))))), vl1);
        s708 = __riscv_vget_f64m1(r118, 0);
        s709 = __riscv_vget_f64m1(r118, 1);
        r119 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((k1 + ((((6)*(l1)))*(m1)))))), vl1);
        s710 = __riscv_vget_f64m1(r119, 0);
        s711 = __riscv_vget_f64m1(r119, 1);
