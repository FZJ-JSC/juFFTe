...
void dft10a_(double *Y, double *X, double *TW1, int *lp1) {
    int l1;
    double *a1022;
    vfloat64m1x2_t r71, r72, r73, r74, r75, r76, r77, r78, 
            r79, r80;
    vfloat64m1_t  a1023, a1024, a1025, a1026, a1027, a1028, a1029, a1030, 
    ...
    for (size_t j1 = 0; j1 < l1; j1 += vl1) {
        ...
        r71 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*(j1))), vl1);
        s516 = __riscv_vget_f64m1(r71, 0);
        s517 = __riscv_vget_f64m1(r71, 1);
        r72 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + l1)))), vl1);
        s518 = __riscv_vget_f64m1(r72, 0);
        s519 = __riscv_vget_f64m1(r72, 1);
        r73 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((2)*(l1)))))), vl1);
        s520 = __riscv_vget_f64m1(r73, 0);
        s521 = __riscv_vget_f64m1(r73, 1);
        r74 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((3)*(l1)))))), vl1);
        s522 = __riscv_vget_f64m1(r74, 0);
        s523 = __riscv_vget_f64m1(r74, 1);
        r75 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((4)*(l1)))))), vl1);
        s524 = __riscv_vget_f64m1(r75, 0);
        s525 = __riscv_vget_f64m1(r75, 1);
        r76 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((5)*(l1)))))), vl1);
        s526 = __riscv_vget_f64m1(r76, 0);
        s527 = __riscv_vget_f64m1(r76, 1);
        r77 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((6)*(l1)))))), vl1);
        s528 = __riscv_vget_f64m1(r77, 0);
        s529 = __riscv_vget_f64m1(r77, 1);
        r78 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((7)*(l1)))))), vl1);
        s530 = __riscv_vget_f64m1(r78, 0);
        s531 = __riscv_vget_f64m1(r78, 1);
        r79 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((8)*(l1)))))), vl1);
        s532 = __riscv_vget_f64m1(r79, 0);
        s533 = __riscv_vget_f64m1(r79, 1);
        r80 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((j1 + ((9)*(l1)))))), vl1);
        s534 = __riscv_vget_f64m1(r80, 0);
        s535 = __riscv_vget_f64m1(r80, 1);
        ...
        a1022 = (TW1 + ((18)*(j1)));
        a1023 = __riscv_vlse64_v_f64m1(a1022, sizeof(double) * 18, vl1);
        a1024 = __riscv_vlse64_v_f64m1((a1022 + 1), sizeof(double) * 18, vl1);
        ...
        a1025 = __riscv_vlse64_v_f64m1((a1022 + 2), sizeof(double) * 18, vl1);
        a1026 = __riscv_vlse64_v_f64m1((a1022 + 3), sizeof(double) * 18, vl1);
        ...
        a1027 = __riscv_vlse64_v_f64m1((a1022 + 4), sizeof(double) * 18, vl1);
        a1028 = __riscv_vlse64_v_f64m1((a1022 + 5), sizeof(double) * 18, vl1);
        ...
        a1029 = __riscv_vlse64_v_f64m1((a1022 + 6), sizeof(double) * 18, vl1);
        a1030 = __riscv_vlse64_v_f64m1((a1022 + 7), sizeof(double) * 18, vl1);
        ...
        a1031 = __riscv_vlse64_v_f64m1((a1022 + 8), sizeof(double) * 18, vl1);
        a1032 = __riscv_vlse64_v_f64m1((a1022 + 9), sizeof(double) * 18, vl1);
        ...
        a1033 = __riscv_vlse64_v_f64m1((a1022 + 10), sizeof(double) * 18, vl1);
        a1034 = __riscv_vlse64_v_f64m1((a1022 + 11), sizeof(double) * 18, vl1);
        ...
        a1035 = __riscv_vlse64_v_f64m1((a1022 + 12), sizeof(double) * 18, vl1);
        a1036 = __riscv_vlse64_v_f64m1((a1022 + 13), sizeof(double) * 18, vl1);
        ...
        a1037 = __riscv_vlse64_v_f64m1((a1022 + 14), sizeof(double) * 18, vl1);
        a1038 = __riscv_vlse64_v_f64m1((a1022 + 15), sizeof(double) * 18, vl1);
        ...
        a1039 = __riscv_vlse64_v_f64m1((a1022 + 16), sizeof(double) * 18, vl1);
        a1040 = __riscv_vlse64_v_f64m1((a1022 + 17), sizeof(double) * 18, vl1);
        ...
        __riscv_vsse64((Y + ((20)*(j1))), sizeof(double) * 20, s556, vl1);
        __riscv_vsse64((1 + Y + ((20)*(j1))), sizeof(double) * 20, s557, vl1);
        __riscv_vsse64((2 + Y + ((20)*(j1))), sizeof(double) * 20, s576, vl1);
        __riscv_vsse64((3 + Y + ((20)*(j1))), sizeof(double) * 20, s577, vl1);
        __riscv_vsse64((4 + Y + ((20)*(j1))), sizeof(double) * 20, s578, vl1);
        __riscv_vsse64((5 + Y + ((20)*(j1))), sizeof(double) * 20, s579, vl1);
        __riscv_vsse64((6 + Y + ((20)*(j1))), sizeof(double) * 20, s580, vl1);
        __riscv_vsse64((7 + Y + ((20)*(j1))), sizeof(double) * 20, s581, vl1);
        __riscv_vsse64((8 + Y + ((20)*(j1))), sizeof(double) * 20, s582, vl1);
        __riscv_vsse64((9 + Y + ((20)*(j1))), sizeof(double) * 20, s583, vl1);
        __riscv_vsse64((10 + Y + ((20)*(j1))), sizeof(double) * 20, s584, vl1);
        __riscv_vsse64((11 + Y + ((20)*(j1))), sizeof(double) * 20, s585, vl1);
        __riscv_vsse64((12 + Y + ((20)*(j1))), sizeof(double) * 20, s586, vl1);
        __riscv_vsse64((13 + Y + ((20)*(j1))), sizeof(double) * 20, s587, vl1);
        __riscv_vsse64((14 + Y + ((20)*(j1))), sizeof(double) * 20, s588, vl1);
        __riscv_vsse64((15 + Y + ((20)*(j1))), sizeof(double) * 20, s589, vl1);
        __riscv_vsse64((16 + Y + ((20)*(j1))), sizeof(double) * 20, s590, vl1);
        __riscv_vsse64((17 + Y + ((20)*(j1))), sizeof(double) * 20, s591, vl1);
        __riscv_vsse64((18 + Y + ((20)*(j1))), sizeof(double) * 20, s592, vl1);
        __riscv_vsse64((19 + Y + ((20)*(j1))), sizeof(double) * 20, s593, vl1);
    }
}
