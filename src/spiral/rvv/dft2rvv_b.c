...
void dft2b_(double *Y, double *X, double *TW1, int *lp1, int *mp1) {
    double a114, a115;
    int a112, a113, j1, l1, m1;
    vfloat64m1x2_t r33, r34, r35, r36, rvvx2_3, rvvx2_4;
    vfloat64m1_t  s35, s36, s37, s38, s39, s40;
    size_t vl1;
    l1 = *(lp1);
    m1 = *(mp1);
...
#pragma GCC unroll 4
        for (size_t k1 = 0; k1 < m1; k1 += vl1) {
            ...
            a112 = (k1 + ((j1)*(m1)));
            r33 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*(a112))), vl1);
            s35 = __riscv_vget_f64m1(r33, 0);
            s36 = __riscv_vget_f64m1(r33, 1);
            r34 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((a112 + ((l1)*(m1)))))), vl1);
            s37 = __riscv_vget_f64m1(r34, 0);
            s38 = __riscv_vget_f64m1(r34, 1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((2)*(j1)))*(m1)))))), r35, vl1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((2)*(j1)))*(m1)) + m1)))), r36, vl1);
        }
    }
}
