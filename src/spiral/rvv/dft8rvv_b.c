...
void dft8b_(double *Y, double *X, double *TW1, int *lp1, int *mp1) {
    double a729, a730, a731, a732, a733, a734, a735, a736, 
            a737, a738, a739, a740, a741, a742;
    int a723, a728, j1, l1, m1;
    ...
    vfloat64m1_t  a724, a725, a726, a727, s215, s216, s217, s218, 
    ...
    for(int j1 = 1; j1 < l1; j1++) {
        for (size_t k1 = 0; k1 < m1; k1 += vl1) {
            ...
            a723 = (k1 + ((j1)*(m1)));
            r129 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*(a723))), vl1);
            s215 = __riscv_vget_f64m1(r129, 0);
            s216 = __riscv_vget_f64m1(r129, 1);
            r130 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((a723 + ((l1)*(m1)))))), vl1);
            s217 = __riscv_vget_f64m1(r130, 0);
            s218 = __riscv_vget_f64m1(r130, 1);
            r131 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((a723 + ((((2)*(l1)))*(m1)))))), vl1);
            s219 = __riscv_vget_f64m1(r131, 0);
            s220 = __riscv_vget_f64m1(r131, 1);
            r132 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((a723 + ((((3)*(l1)))*(m1)))))), vl1);
            s221 = __riscv_vget_f64m1(r132, 0);
            s222 = __riscv_vget_f64m1(r132, 1);
            r133 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((a723 + ((((4)*(l1)))*(m1)))))), vl1);
            s223 = __riscv_vget_f64m1(r133, 0);
            s224 = __riscv_vget_f64m1(r133, 1);
            r134 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((a723 + ((((5)*(l1)))*(m1)))))), vl1);
            s225 = __riscv_vget_f64m1(r134, 0);
            s226 = __riscv_vget_f64m1(r134, 1);
            r135 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((a723 + ((((6)*(l1)))*(m1)))))), vl1);
            s227 = __riscv_vget_f64m1(r135, 0);
            s228 = __riscv_vget_f64m1(r135, 1);
            r136 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((a723 + ((((7)*(l1)))*(m1)))))), vl1);
            s229 = __riscv_vget_f64m1(r136, 0);
            s230 = __riscv_vget_f64m1(r136, 1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((8)*(j1)))*(m1)))))), r137, vl1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((8)*(j1)))*(m1)) + m1)))), r138, vl1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((8)*(j1)))*(m1)) + ((2)*(m1)))))), r139, vl1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((8)*(j1)))*(m1)) + ((3)*(m1)))))), r140, vl1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((8)*(j1)))*(m1)) + ((4)*(m1)))))), r141, vl1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((8)*(j1)))*(m1)) + ((5)*(m1)))))), r142, vl1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((8)*(j1)))*(m1)) + ((6)*(m1)))))), r143, vl1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((8)*(j1)))*(m1)) + ((7)*(m1)))))), r144, vl1);
        }
    }
}
