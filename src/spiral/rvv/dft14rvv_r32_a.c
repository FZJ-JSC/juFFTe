...
void dft14a_r32_(float *Y, float *X, float *TW1, int64_t *lp1) {
    int64_t l1;
    float *a3574;
    vfloat32m1x2_t r100, r101, r102, r103, r104, r105, r106, r107, 
            r108, r109, r110, r111, r112, r99;
    vfloat32m1_t  a3575, a3576, a3577, a3578, a3579, a3580, a3581, a3582, 
    ...
    for (size_t j1 = 0; j1 < l1; j1 += vl1) {
        ...
        r99 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(j1))), vl1);
        s2800 = __riscv_vget_f32m1(r99, 0);
        s2801 = __riscv_vget_f32m1(r99, 1);
        r100 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + l1)))), vl1);
        s2802 = __riscv_vget_f32m1(r100, 0);
        s2803 = __riscv_vget_f32m1(r100, 1);
        r101 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((2)*(l1)))))), vl1);
        s2804 = __riscv_vget_f32m1(r101, 0);
        s2805 = __riscv_vget_f32m1(r101, 1);
        r102 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((3)*(l1)))))), vl1);
        s2806 = __riscv_vget_f32m1(r102, 0);
        s2807 = __riscv_vget_f32m1(r102, 1);
        r103 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((4)*(l1)))))), vl1);
        s2808 = __riscv_vget_f32m1(r103, 0);
        s2809 = __riscv_vget_f32m1(r103, 1);
        r104 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((5)*(l1)))))), vl1);
        s2810 = __riscv_vget_f32m1(r104, 0);
        s2811 = __riscv_vget_f32m1(r104, 1);
        r105 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((6)*(l1)))))), vl1);
        s2812 = __riscv_vget_f32m1(r105, 0);
        s2813 = __riscv_vget_f32m1(r105, 1);
        r106 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((7)*(l1)))))), vl1);
        s2814 = __riscv_vget_f32m1(r106, 0);
        s2815 = __riscv_vget_f32m1(r106, 1);
        r107 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((8)*(l1)))))), vl1);
        s2816 = __riscv_vget_f32m1(r107, 0);
        s2817 = __riscv_vget_f32m1(r107, 1);
        r108 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((9)*(l1)))))), vl1);
        s2818 = __riscv_vget_f32m1(r108, 0);
        s2819 = __riscv_vget_f32m1(r108, 1);
        r109 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((10)*(l1)))))), vl1);
        s2820 = __riscv_vget_f32m1(r109, 0);
        s2821 = __riscv_vget_f32m1(r109, 1);
        r110 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((11)*(l1)))))), vl1);
        s2822 = __riscv_vget_f32m1(r110, 0);
        s2823 = __riscv_vget_f32m1(r110, 1);
        r111 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((12)*(l1)))))), vl1);
        s2824 = __riscv_vget_f32m1(r111, 0);
        s2825 = __riscv_vget_f32m1(r111, 1);
        r112 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((13)*(l1)))))), vl1);
        s2826 = __riscv_vget_f32m1(r112, 0);
        s2827 = __riscv_vget_f32m1(r112, 1);
        ...
        a3574 = (TW1 + ((26)*(j1)));
        a3575 = __riscv_vlse32_v_f32m1(a3574, sizeof(double) * 26, vl1);
        a3576 = __riscv_vlse32_v_f32m1((a3574 + 1), sizeof(double) * 26, vl1);
        ...
        a3577 = __riscv_vlse32_v_f32m1((a3574 + 2), sizeof(double) * 26, vl1);
        a3578 = __riscv_vlse32_v_f32m1((a3574 + 3), sizeof(double) * 26, vl1);
        ...
        a3579 = __riscv_vlse32_v_f32m1((a3574 + 4), sizeof(double) * 26, vl1);
        a3580 = __riscv_vlse32_v_f32m1((a3574 + 5), sizeof(double) * 26, vl1);
        ...
        a3581 = __riscv_vlse32_v_f32m1((a3574 + 6), sizeof(double) * 26, vl1);
        a3582 = __riscv_vlse32_v_f32m1((a3574 + 7), sizeof(double) * 26, vl1);
        ...
        a3583 = __riscv_vlse32_v_f32m1((a3574 + 8), sizeof(double) * 26, vl1);
        a3584 = __riscv_vlse32_v_f32m1((a3574 + 9), sizeof(double) * 26, vl1);
        ...
        a3585 = __riscv_vlse32_v_f32m1((a3574 + 10), sizeof(double) * 26, vl1);
        a3586 = __riscv_vlse32_v_f32m1((a3574 + 11), sizeof(double) * 26, vl1);
        ...
        a3587 = __riscv_vlse32_v_f32m1((a3574 + 12), sizeof(double) * 26, vl1);
        a3588 = __riscv_vlse32_v_f32m1((a3574 + 13), sizeof(double) * 26, vl1);
        ...
        a3589 = __riscv_vlse32_v_f32m1((a3574 + 14), sizeof(double) * 26, vl1);
        a3590 = __riscv_vlse32_v_f32m1((a3574 + 15), sizeof(double) * 26, vl1);
        ...
        a3591 = __riscv_vlse32_v_f32m1((a3574 + 16), sizeof(double) * 26, vl1);
        a3592 = __riscv_vlse32_v_f32m1((a3574 + 17), sizeof(double) * 26, vl1);
        ...
        a3593 = __riscv_vlse32_v_f32m1((a3574 + 18), sizeof(double) * 26, vl1);
        a3594 = __riscv_vlse32_v_f32m1((a3574 + 19), sizeof(double) * 26, vl1);
        ...
        a3595 = __riscv_vlse32_v_f32m1((a3574 + 20), sizeof(double) * 26, vl1);
        a3596 = __riscv_vlse32_v_f32m1((a3574 + 21), sizeof(double) * 26, vl1);
        ...
        a3597 = __riscv_vlse32_v_f32m1((a3574 + 22), sizeof(double) * 26, vl1);
        a3598 = __riscv_vlse32_v_f32m1((a3574 + 23), sizeof(double) * 26, vl1);
        ...
        a3599 = __riscv_vlse32_v_f32m1((a3574 + 24), sizeof(double) * 26, vl1);
        a3600 = __riscv_vlse32_v_f32m1((a3574 + 25), sizeof(double) * 26, vl1);
        ...
        __riscv_vsse32((Y + ((28)*(j1))), sizeof(double) * 28, s2892, vl1);
        __riscv_vsse32((1 + Y + ((28)*(j1))), sizeof(double) * 28, s2893, vl1);
        __riscv_vsse32((2 + Y + ((28)*(j1))), sizeof(double) * 28, s2920, vl1);
        __riscv_vsse32((3 + Y + ((28)*(j1))), sizeof(double) * 28, s2921, vl1);
        __riscv_vsse32((4 + Y + ((28)*(j1))), sizeof(double) * 28, s2922, vl1);
        __riscv_vsse32((5 + Y + ((28)*(j1))), sizeof(double) * 28, s2923, vl1);
        __riscv_vsse32((6 + Y + ((28)*(j1))), sizeof(double) * 28, s2924, vl1);
        __riscv_vsse32((7 + Y + ((28)*(j1))), sizeof(double) * 28, s2925, vl1);
        __riscv_vsse32((8 + Y + ((28)*(j1))), sizeof(double) * 28, s2926, vl1);
        __riscv_vsse32((9 + Y + ((28)*(j1))), sizeof(double) * 28, s2927, vl1);
        __riscv_vsse32((10 + Y + ((28)*(j1))), sizeof(double) * 28, s2928, vl1);
        __riscv_vsse32((11 + Y + ((28)*(j1))), sizeof(double) * 28, s2929, vl1);
        __riscv_vsse32((12 + Y + ((28)*(j1))), sizeof(double) * 28, s2930, vl1);
        __riscv_vsse32((13 + Y + ((28)*(j1))), sizeof(double) * 28, s2931, vl1);
        __riscv_vsse32((14 + Y + ((28)*(j1))), sizeof(double) * 28, s2932, vl1);
        __riscv_vsse32((15 + Y + ((28)*(j1))), sizeof(double) * 28, s2933, vl1);
        __riscv_vsse32((16 + Y + ((28)*(j1))), sizeof(double) * 28, s2934, vl1);
        __riscv_vsse32((17 + Y + ((28)*(j1))), sizeof(double) * 28, s2935, vl1);
        __riscv_vsse32((18 + Y + ((28)*(j1))), sizeof(double) * 28, s2936, vl1);
        __riscv_vsse32((19 + Y + ((28)*(j1))), sizeof(double) * 28, s2937, vl1);
        __riscv_vsse32((20 + Y + ((28)*(j1))), sizeof(double) * 28, s2938, vl1);
        __riscv_vsse32((21 + Y + ((28)*(j1))), sizeof(double) * 28, s2939, vl1);
        __riscv_vsse32((22 + Y + ((28)*(j1))), sizeof(double) * 28, s2940, vl1);
        __riscv_vsse32((23 + Y + ((28)*(j1))), sizeof(double) * 28, s2941, vl1);
        __riscv_vsse32((24 + Y + ((28)*(j1))), sizeof(double) * 28, s2942, vl1);
        __riscv_vsse32((25 + Y + ((28)*(j1))), sizeof(double) * 28, s2943, vl1);
        __riscv_vsse32((26 + Y + ((28)*(j1))), sizeof(double) * 28, s2944, vl1);
        __riscv_vsse32((27 + Y + ((28)*(j1))), sizeof(double) * 28, s2945, vl1);
    }
}
