...
void dft4b_r32_(float *Y, float *X, float *TW1, int64_t *lp1, int64_t *mp1) {
    float a280, a281, a282, a283, a284, a285;
    int64_t a278, a279, j1, l1, m1;
    vfloat32m1x2_t r65, r66, r67, r68, r69, r70, r71, r72, 
            rvvx2_5, rvvx2_6, rvvx2_7, rvvx2_8;
    vfloat32m1_t  s75, s76, s77, s78, s79, s80, s81, s82, 
    ...
    for(int j2 = 0; j2 < (l1 - 1); j2++) {
        ...
        for(int j2 = 0; j2 < l1; j2++) {
            for (size_t k1 = 0; k1 < m1; k1 += vl1) {
                ...
                a278 = (k1 + ((j1)*(m1)));
                r65 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(a278))), vl1);
                s75 = __riscv_vget_f32m1(r65, 0);
                s76 = __riscv_vget_f32m1(r65, 1);
                r66 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((a278 + ((l1)*(m1)))))), vl1);
                s77 = __riscv_vget_f32m1(r66, 0);
                s78 = __riscv_vget_f32m1(r66, 1);
                r67 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((a278 + ((((2)*(l1)))*(m1)))))), vl1);
                s79 = __riscv_vget_f32m1(r67, 0);
                s80 = __riscv_vget_f32m1(r67, 1);
                r68 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((a278 + ((((3)*(l1)))*(m1)))))), vl1);
                s81 = __riscv_vget_f32m1(r68, 0);
                s82 = __riscv_vget_f32m1(r68, 1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((4)*(j1)))*(m1)))))), r69, vl1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((4)*(j1)))*(m1)) + m1)))), r70, vl1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((4)*(j1)))*(m1)) + ((2)*(m1)))))), r71, vl1);
                ...
                __riscv_vsseg2e32((Y + ((2)*((k1 + ((((4)*(j1)))*(m1)) + ((3)*(m1)))))), r72, vl1);
            }
        }
    }
}
