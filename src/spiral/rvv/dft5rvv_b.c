...
void dft5b_(double *Y, double *X, double *TW1, int *lp1, int *mp1) {
    double a428, a429, a430, a431, a432, a433, a434, a435;
    int a426, a427, j1, l1, m1;
    vfloat64m1x2_t r81, r82, r83, r84, r85, r86, r87, r88, 
            r89, r90, rvvx2_10, rvvx2_6, rvvx2_7, rvvx2_8, rvvx2_9;
    vfloat64m1_t  s161, s162, s163, s164, s165, s166, s167, s168, 
    ...
    for(int j1 = 1; j1 < l1; j1++) {
        for (size_t k1 = 0; k1 < m1; k1 += vl1) {
            ...
            a426 = (k1 + ((j1)*(m1)));
            r81 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*(a426))), vl1);
            s161 = __riscv_vget_f64m1(r81, 0);
            s162 = __riscv_vget_f64m1(r81, 1);
            r82 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((a426 + ((l1)*(m1)))))), vl1);
            s163 = __riscv_vget_f64m1(r82, 0);
            s164 = __riscv_vget_f64m1(r82, 1);
            r83 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((a426 + ((((2)*(l1)))*(m1)))))), vl1);
            s165 = __riscv_vget_f64m1(r83, 0);
            s166 = __riscv_vget_f64m1(r83, 1);
            r84 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((a426 + ((((3)*(l1)))*(m1)))))), vl1);
            s167 = __riscv_vget_f64m1(r84, 0);
            s168 = __riscv_vget_f64m1(r84, 1);
            r85 = __riscv_vlseg2e64_v_f64m1x2((X + ((2)*((a426 + ((((4)*(l1)))*(m1)))))), vl1);
            s169 = __riscv_vget_f64m1(r85, 0);
            s170 = __riscv_vget_f64m1(r85, 1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((5)*(j1)))*(m1)))))), r86, vl1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((5)*(j1)))*(m1)) + m1)))), r87, vl1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((5)*(j1)))*(m1)) + ((2)*(m1)))))), r88, vl1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((5)*(j1)))*(m1)) + ((3)*(m1)))))), r89, vl1);
            ...
            __riscv_vsseg2e64((Y + ((2)*((k1 + ((((5)*(j1)))*(m1)) + ((4)*(m1)))))), r90, vl1);
        }
    }
}
