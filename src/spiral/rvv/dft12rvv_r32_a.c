...
void dft12a_r32_(float *Y, float *X, float *TW1, int64_t *lp1) {
    int64_t l1;
    float *a1602;
    vfloat32m1x2_t r85, r86, r87, r88, r89, r90, r91, r92, 
            r93, r94, r95, r96;
    vfloat32m1_t  a1603, a1604, a1605, a1606, a1607, a1608, a1609, a1610, 
    ...
    for (size_t j1 = 0; j1 < l1; j1 += vl1) {
        ...
        r85 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(j1))), vl1);
        s884 = __riscv_vget_f32m1(r85, 0);
        s885 = __riscv_vget_f32m1(r85, 1);
        r86 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + l1)))), vl1);
        s886 = __riscv_vget_f32m1(r86, 0);
        s887 = __riscv_vget_f32m1(r86, 1);
        r87 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((2)*(l1)))))), vl1);
        s888 = __riscv_vget_f32m1(r87, 0);
        s889 = __riscv_vget_f32m1(r87, 1);
        r88 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((3)*(l1)))))), vl1);
        s890 = __riscv_vget_f32m1(r88, 0);
        s891 = __riscv_vget_f32m1(r88, 1);
        r89 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((4)*(l1)))))), vl1);
        s892 = __riscv_vget_f32m1(r89, 0);
        s893 = __riscv_vget_f32m1(r89, 1);
        r90 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((5)*(l1)))))), vl1);
        s894 = __riscv_vget_f32m1(r90, 0);
        s895 = __riscv_vget_f32m1(r90, 1);
        r91 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((6)*(l1)))))), vl1);
        s896 = __riscv_vget_f32m1(r91, 0);
        s897 = __riscv_vget_f32m1(r91, 1);
        r92 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((7)*(l1)))))), vl1);
        s898 = __riscv_vget_f32m1(r92, 0);
        s899 = __riscv_vget_f32m1(r92, 1);
        r93 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((8)*(l1)))))), vl1);
        s900 = __riscv_vget_f32m1(r93, 0);
        s901 = __riscv_vget_f32m1(r93, 1);
        r94 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((9)*(l1)))))), vl1);
        s902 = __riscv_vget_f32m1(r94, 0);
        s903 = __riscv_vget_f32m1(r94, 1);
        r95 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((10)*(l1)))))), vl1);
        s904 = __riscv_vget_f32m1(r95, 0);
        s905 = __riscv_vget_f32m1(r95, 1);
        r96 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((j1 + ((11)*(l1)))))), vl1);
        s906 = __riscv_vget_f32m1(r96, 0);
        s907 = __riscv_vget_f32m1(r96, 1);
        ...
        a1602 = (TW1 + ((22)*(j1)));
        a1603 = __riscv_vlse32_v_f32m1(a1602, sizeof(double) * 22, vl1);
        a1604 = __riscv_vlse32_v_f32m1((a1602 + 1), sizeof(double) * 22, vl1);
        ...
        a1605 = __riscv_vlse32_v_f32m1((a1602 + 2), sizeof(double) * 22, vl1);
        a1606 = __riscv_vlse32_v_f32m1((a1602 + 3), sizeof(double) * 22, vl1);
        ...
        a1607 = __riscv_vlse32_v_f32m1((a1602 + 4), sizeof(double) * 22, vl1);
        a1608 = __riscv_vlse32_v_f32m1((a1602 + 5), sizeof(double) * 22, vl1);
        ...
        a1609 = __riscv_vlse32_v_f32m1((a1602 + 6), sizeof(double) * 22, vl1);
        a1610 = __riscv_vlse32_v_f32m1((a1602 + 7), sizeof(double) * 22, vl1);
        ...
        a1611 = __riscv_vlse32_v_f32m1((a1602 + 8), sizeof(double) * 22, vl1);
        a1612 = __riscv_vlse32_v_f32m1((a1602 + 9), sizeof(double) * 22, vl1);
        ...
        a1613 = __riscv_vlse32_v_f32m1((a1602 + 10), sizeof(double) * 22, vl1);
        a1614 = __riscv_vlse32_v_f32m1((a1602 + 11), sizeof(double) * 22, vl1);
        ...
        a1615 = __riscv_vlse32_v_f32m1((a1602 + 12), sizeof(double) * 22, vl1);
        a1616 = __riscv_vlse32_v_f32m1((a1602 + 13), sizeof(double) * 22, vl1);
        ...
        a1617 = __riscv_vlse32_v_f32m1((a1602 + 14), sizeof(double) * 22, vl1);
        a1618 = __riscv_vlse32_v_f32m1((a1602 + 15), sizeof(double) * 22, vl1);
        ...
        a1619 = __riscv_vlse32_v_f32m1((a1602 + 16), sizeof(double) * 22, vl1);
        a1620 = __riscv_vlse32_v_f32m1((a1602 + 17), sizeof(double) * 22, vl1);
        ...
        a1621 = __riscv_vlse32_v_f32m1((a1602 + 18), sizeof(double) * 22, vl1);
        a1622 = __riscv_vlse32_v_f32m1((a1602 + 19), sizeof(double) * 22, vl1);
        ...
        a1623 = __riscv_vlse32_v_f32m1((a1602 + 20), sizeof(double) * 22, vl1);
        a1624 = __riscv_vlse32_v_f32m1((a1602 + 21), sizeof(double) * 22, vl1);
        ...
        __riscv_vsse32((Y + ((24)*(j1))), sizeof(double) * 24, s918, vl1);
        __riscv_vsse32((1 + Y + ((24)*(j1))), sizeof(double) * 24, s919, vl1);
        __riscv_vsse32((2 + Y + ((24)*(j1))), sizeof(double) * 24, s948, vl1);
        __riscv_vsse32((3 + Y + ((24)*(j1))), sizeof(double) * 24, s949, vl1);
        __riscv_vsse32((4 + Y + ((24)*(j1))), sizeof(double) * 24, s950, vl1);
        __riscv_vsse32((5 + Y + ((24)*(j1))), sizeof(double) * 24, s951, vl1);
        __riscv_vsse32((6 + Y + ((24)*(j1))), sizeof(double) * 24, s952, vl1);
        __riscv_vsse32((7 + Y + ((24)*(j1))), sizeof(double) * 24, s953, vl1);
        __riscv_vsse32((8 + Y + ((24)*(j1))), sizeof(double) * 24, s954, vl1);
        __riscv_vsse32((9 + Y + ((24)*(j1))), sizeof(double) * 24, s955, vl1);
        __riscv_vsse32((10 + Y + ((24)*(j1))), sizeof(double) * 24, s956, vl1);
        __riscv_vsse32((11 + Y + ((24)*(j1))), sizeof(double) * 24, s957, vl1);
        __riscv_vsse32((12 + Y + ((24)*(j1))), sizeof(double) * 24, s958, vl1);
        __riscv_vsse32((13 + Y + ((24)*(j1))), sizeof(double) * 24, s959, vl1);
        __riscv_vsse32((14 + Y + ((24)*(j1))), sizeof(double) * 24, s960, vl1);
        __riscv_vsse32((15 + Y + ((24)*(j1))), sizeof(double) * 24, s961, vl1);
        __riscv_vsse32((16 + Y + ((24)*(j1))), sizeof(double) * 24, s962, vl1);
        __riscv_vsse32((17 + Y + ((24)*(j1))), sizeof(double) * 24, s963, vl1);
        __riscv_vsse32((18 + Y + ((24)*(j1))), sizeof(double) * 24, s964, vl1);
        __riscv_vsse32((19 + Y + ((24)*(j1))), sizeof(double) * 24, s965, vl1);
        __riscv_vsse32((20 + Y + ((24)*(j1))), sizeof(double) * 24, s966, vl1);
        __riscv_vsse32((21 + Y + ((24)*(j1))), sizeof(double) * 24, s967, vl1);
        __riscv_vsse32((22 + Y + ((24)*(j1))), sizeof(double) * 24, s968, vl1);
        __riscv_vsse32((23 + Y + ((24)*(j1))), sizeof(double) * 24, s969, vl1);
    }
}
