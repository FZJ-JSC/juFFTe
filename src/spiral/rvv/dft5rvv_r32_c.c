...
void dft5c_r32_(float *Y, float *X, int64_t *lp1, int64_t *mp1) {
    int64_t l1, m1;
    vfloat32m1x2_t r81, r82, r83, r84, r85, r86, r87, r88, 
            r89, r90, rvvx2_10, rvvx2_6, rvvx2_7, rvvx2_8, rvvx2_9;
    vfloat32m1_t  s137, s138, s139, s140, s141, s142, s143, s144, 
    ...
    for (size_t k1 = 0; k1 < m1; k1 += vl1) {
        ...
        r81 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*(k1))), vl1);
        s137 = __riscv_vget_f32m1(r81, 0);
        s138 = __riscv_vget_f32m1(r81, 1);
        r82 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((l1)*(m1)))))), vl1);
        s139 = __riscv_vget_f32m1(r82, 0);
        s140 = __riscv_vget_f32m1(r82, 1);
        r83 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((2)*(l1)))*(m1)))))), vl1);
        s141 = __riscv_vget_f32m1(r83, 0);
        s142 = __riscv_vget_f32m1(r83, 1);
        r84 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((3)*(l1)))*(m1)))))), vl1);
        s143 = __riscv_vget_f32m1(r84, 0);
        s144 = __riscv_vget_f32m1(r84, 1);
        r85 = __riscv_vlseg2e32_v_f32m1x2((X + ((2)*((k1 + ((((4)*(l1)))*(m1)))))), vl1);
        s145 = __riscv_vget_f32m1(r85, 0);
        s146 = __riscv_vget_f32m1(r85, 1);
